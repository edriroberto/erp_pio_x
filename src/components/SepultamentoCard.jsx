    ...
    return (
      ...
      >
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }} title="Quadra/Local">
            <Star size={12}  color="#718096" />
            <span style={{ fontSize: '11px',  color: '#4a5568' }}>
              <strong>{exibirData(dado.nascimento)}</strong></span>
              <span style={{ fontSize: '11px', margin: '0 8px' }}>•</span>
              <Cross size={12}  color="#718096" />
            <span style={{ fontSize: '11px',  color: '#4a5568' }}>
              <strong>{exibirData(dado.falecimento)}</strong></span>
              <span style={{ fontSize: '11px', marginLeft: 'auto', color: '#2b4c9b' }}><strong>{dado.idade} anos</strong></span>
          </div>                  

        <div style={{ fontSize: '11px', color: '#777', borderTop: '1px solid #f2f2f2', paddingTop: '2px', marginBottom:'3px' }}>
