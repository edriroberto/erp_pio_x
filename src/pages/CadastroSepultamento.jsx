...
const disabledStyle = { ...inputStyle, background: '#f7fafc', cursor: 'not-allowed', color: '#a0aec0' }
  ...
  return (
<div
  className="pagina-rolavel"
  style={{
    maxWidth: isMobile ? "100%" : "1100px",
    width: "100%",
    margin: "0 auto",
    padding: isMobile ? "10px 15px 120px 15px" : "20px",
    fontFamily: "sans-serif",
    overflowY: "auto",
  }}
>
  {/* Cabeçalho */}
  <div style={{ marginTop: isMobile ? "4px" : "10px", marginBottom: "10px" }}>
    <h4
      style={{
        color: "#2d3748",
    ...
    >
      ...
      <div style={groupStyle}>
        ...
        <select
          ...
          value={form.lote_id}
          onChange={handleChange}
          disabled={!form.quadra_id}
          style={{
            ...(form.quadra_id ? inputStyle : disabledStyle),
            width: "100%",
          }}
        >
          <option value="">SELECIONE...</option>
      ...
      <div style={groupStyle}>
        ...
        <select
          ...
          onChange={handleChange}
          disabled={!form.lote_id}
          style={{
            ...(form.lote_id ? inputStyle : disabledStyle),
            width: "100%",
          }}
        >
          <option value="">SELECIONE...</option>
    ...
    >
      ...
      <div style={groupStyle}>
        ...
        <input
          ...
          onChange={handleChange}
          style={{ ...inputStyle, border: "1px solid #38a169", fontWeight: "bold", width: "90%" }}
        />
      </div>
      ...
      <div style={groupStyle}>
        ...
        <select
          name="coveiro_id"
          value={form.coveiro_id}
          onChange={handleChange}
          disabled={!localizacaoDefinida}
          style={{
            ...(localizacaoDefinida ? inputStyle : disabledStyle),
            width: "100%",
          }}
        >
          <option value="">SELECIONE...</option>
      ...
      >
        ...
        <label
          style={{
            fontWeight: 600,
            color: form.obito_entregue ? "#2f855a" : "#c53030",
            fontSize: "0.9rem",
          }}
        >
          {form.obito_entregue ? "ÓBITO ENTREGUE" : "ÓBITO PENDENTE"}
        </label>
      </div>
    </div>
  </div>
  ...
  >
    <div style={groupStyle}>
      ...
      <textarea
        ...
        onChange={handleChange}
        rows="3"
        style={{ ...inputStyle, resize: "none", width: "95%" }}
      />
    </div>
    ...
    >
      <div style={{ display: "flex", gap: "15px" }}>
        <button
          onClick={() => navigate("/sepultamentos")}
          style={{
            padding: "12px 25px",
            borderRadius: "6px",
            border: "1px solid #cbd5e0",
